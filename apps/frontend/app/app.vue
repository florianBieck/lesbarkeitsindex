              ...
              <div class="flex flex-col lg:flex-row justify-between gap-4 relative -mt-8 -top-[70px] -mb-[70px]">
                <div class="flex flex-col gap-4 flex-1">
                  ...
                  <div class="flex flex-col gap-2 w-full">
                    <h1 class="text-surface-900 text-xl md:text-[24.5px] leading-tight md:leading-[30.62px] font-bold w-full">
                      Lübecker Lesbarkeitsindex (LÜ-LIX)
                    </h1>
                    <div class="text-surface-900 text-sm md:text-[17.5px] leading-normal md:leading-[21.88px] w-full">
