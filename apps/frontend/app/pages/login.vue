    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="flex flex-col gap-6 w-full">
        <div class="flex flex-col gap-2 w-full">
          <label for="email1" class="text-surface-900 font-medium leading-normal">E-Mail Adresse</label>
          <InputText id="email1" v-model="email" fluid type="text" placeholder="E-Mail-Adresse" class="px-3 py-2 shadow-sm rounded-lg" />
        </div>
        <div class="flex flex-col gap-2 w-full">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between w-full gap-3 sm:gap-0">
          <div class="flex items-center gap-2">
            ...
            <label for="rememberme1" class="text-surface-900 leading-normal">Anmeldung speichern?</label>
          </div>
